...
final class MediaController extends AbstractController
{
    ...
    public function get(Media $media, SerializerInterface $serializer, UrlGeneratorInterface $urlGenerator): JsonResponse
    {
        ...
        return $media ?
            new JsonResponse($serializer->serialize($media, 'json', []), Response::HTTP_OK, [
                'location' => $location,
            ], true) :
    ...
    public function create(Request $request, EntityManagerInterface $entityManager, SerializerInterface $serializer, UrlGeneratorInterface $urlGenerator): JsonResponse
    {
        $media = new Media();
